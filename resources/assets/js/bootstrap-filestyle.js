(function($) {
	...
	Filestyle.prototype = {
		...
		badge : function(value) {
			if (value === true) {
				...
				this.$elementFilestyle.find('label').append('<i class="bx bx-plus label-icon"></i>');
			} else if (value === false) {
				this.options.badge = value;
				this.$elementFilestyle.find('.badge').remove();
			} else {
	...
	$.fn.filestyle.defaults = {
		'text' : 'Choose file',
		'htmlIcon' : '<i class="bx bx-plus label-icon"></i>',
		'btnClass' : 'btn btn-primary waves-effect btn-label waves-light btn-sm',
		'size' : 'nr',
		'input' : true,
		'badge' : false,

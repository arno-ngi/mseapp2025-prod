                        ...
                        <div class="d-flex flex-column h-100">
                            ...
                            <div class="auth-content my-auto">
                                <div class="text-center">
                                    <h5 class="mb-0">{{__('law.password_reset')}}</h5>
                                </div>
                                ...
                                <form method="POST" action="{{ route('password.update') }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="email" class="form-control" id="email" name="email" value="{{old('email', $request->email)}}" placeholder="{{__('law.email')}}">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        <div class="d-flex align-items-start">
                                            <div class="flex-grow-1">
                                                <label class="form-label">{{__('law.password_confirm')}}</label>
                                            </div>
                                        </div>

                                        <div class="input-group auth-pass-inputgroup">
                                            <input type="password" class="form-control" placeholder="{{__('law.password')}}" id="password_confirmation" name="password_confirmation" aria-label="Password Confirm" aria-describedby="password-addon2">
                                        </div>
                                    </div>

                                    <div class="mb-3">
                                        <button class="btn btn-primary w-100 waves-effect waves-light" type="submit">
                                            {{__('law.password_reset')}}</button>
                                    </div>
                                </form>

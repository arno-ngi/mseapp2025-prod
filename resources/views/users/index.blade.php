        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">{{__('law.users')}}</h4>
                    <div class="flex-shrink-0">
                        <div class="d-flex flex-wrap gap-2 mb-0 my-n1">
                            <a href="{{route('users.create')}}" class="btn btn-primary waves-effect btn-label waves-light btn-sm">
                                <i
                    ...
                    <table id="datatable" class="table table-bordered dt-responsive nowrap w-100">
                        ...
                        @foreach($users as $user)
                            <tr>
                                ...
                                <td><a href="{{route('users.edit', $user)}}">{{$user->firstname}}</a></td>
                                <td><a href="{{route('users.edit', $user)}}">{{$user->email}}</a></td>
                                <td>{{$user->is_active ? __('law.yes') : __('law.no')}}</td>
